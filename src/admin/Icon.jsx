...
/* The admin's icons: plain 24px strokes drawn inline, in the style of Lucide
   (ISC), so there is no icon font to load and every icon matches. */
const P = {
  dashboard: (
    <>
  ...
  steps: <path d="M10 6h11M10 12h11M10 18h11M4 6h1v4M4 10h2M6 18H4c0-1 2-2 2-3s-1-1.5-2-1" />,
  sparkle: <path d="M9.94 14.06 4 20M12 2l2.4 7.2L22 12l-7.6 2.8L12 22l-2.4-7.2L2 12l7.6-2.8Z" />,
  building: (
    <>
